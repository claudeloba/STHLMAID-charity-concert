...
export const getSEOTags = ({
  ...
  return {
    ...
    openGraph: {
      title:
        openGraph?.title ||
        "STHLM AID Charity Concert. Live at Trädgården, Stockholm, May 30th.",
    ...
    twitter: {
      title:
        openGraph?.title ||
        "STHLM AID Charity Concert: Secure your tickets to Stockholm Aid charity concert at Trädgården, Stockholm on May 30th now.",
      description: openGraph?.description || config.appDescription,
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          "@type": "MusicEvent",
          name: "STHLM AID Stockholm Aid Charity Concert",
          ...
          location: {
            ...
            address: {
              "@type": "PostalAddress",
              streetAddress: "Hammarby Slussväg 2",
              addressLocality: "Stockholm",
              postalCode: "118 60",
              addressCountry: "SE",
            },
          },
          image: [`https://${config.domainName}/sthlm-aid.jpg`],
          offers: {
            "@type": "Offer",
            url: "https://www.tickster.com/se/sv/events/tmjyg8tn6x8jfmb/2024-05-30/sthlm-aid",
            price: "0",
            priceCurrency: "SEK",
            availability: "http://schema.org/InStock",
            validFrom: "2024-05-01T00:00",
          },
          performer: config.artists.map((artist) => ({
            "@type": "Person",
            name: artist,
          })),
          organizer: {
